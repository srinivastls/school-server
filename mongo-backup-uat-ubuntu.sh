...
PARENT_FOLDER=1I5qAUxNQQ64Z5M9FHcYI20ybSyiZ09cL

mongodump -d $DB_NAME --archive=$DEST --gzip

# file ID will be the first word in line 2
prevBackupId=`~/server/school/gdrive --service-account sa.json list --query "'1I5qAUxNQQ64Z5M9FHcYI20ybSyiZ09cL' in parents" | awk 'NR == 2 {print $1}'`
