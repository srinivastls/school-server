...
exports.bulkMarkTeacherAttendance = exports.getDailyTeacherAttendance = exports.getTeachersForAttendance = exports.getTeachers = void 0;
...
const attendanceDate_1 = require("../utils/attendanceDate");
const getTeachersForAttendance = async (req, res) => {
    try {
        ...
        const attendanceDate = (0, attendanceDate_1.parseAttendanceDate)(date);
        if (!attendanceDate) {
            return res.status(400).json({
                message: "Invalid date. Use YYYY-MM-DD or DD/MM/YYYY format.",
            });
        }
...
const bulkMarkTeacherAttendance = async (req, res) => {
    try {
        ...
        const date = (0, attendanceDate_1.parseAttendanceDate)(req.body?.date);
        ...
        const teachers = await config_1.prisma.user.findMany({
            where: { schoolId,
                role: client_1.RoleName.TEACHER, isActive: true },
            select: { id: true },
        });
